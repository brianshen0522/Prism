...
export function MyConnectionsPage() {
  ...
  }, [showHeartbeatTraffic, setSearchParams]);
  ...
  const queryKey = [
    'connections-my',
    scope, filtersString ?? '', showHeartbeatTraffic ? 'heartbeat' : 'default', sort, order,
  ];
        ...
        {view === 'raw' && (
          <FilterCard className="hidden md:block">
            ...
            <div className="mt-4 flex items-center gap-2 border-t border-gray-200 pt-4 text-sm dark:border-gray-700">
              <input
                id="show_heartbeat_traffic_my"
                type="checkbox"
                checked={showHeartbeatTraffic}
                onChange={(e) => setShowHeartbeatTraffic(e.target.checked)}
                className="rounded border-gray-300"
              />
              <label htmlFor="show_heartbeat_traffic_my" className="text-gray-700 dark:text-gray-300">
        ...
        >
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-2 border-t border-gray-200 pt-4 text-sm dark:border-gray-700">
              <input
                id="show_heartbeat_traffic_my_mobile"
                type="checkbox"
                checked={showHeartbeatTraffic}
                onChange={(e) => setShowHeartbeatTraffic(e.target.checked)}
                className="rounded border-gray-300"
              />
              <label htmlFor="show_heartbeat_traffic_my_mobile" className="text-gray-700 dark:text-gray-300">
                Show system heartbeat traffic
              </label>
            </div>
          </div>
